...
- **Primary files to open first**: `corpus/ufli/audio_companion.py`, `corpus/ufli/audio_diagnostics.py`, `corpus/ufli/audio_companion_schema.py`, `data/ufli/companion/pronunciation_lexicon.yaml`, `corpus/ufli/ingest.py`
