...
**Last Updated:** 2026-06-12 (planner-simplification Tasks 0–12 shipped behind WORKSHEET_PLANNER_V2, default OFF; A/B battery failed the promotion gate; judge-visibility fix landed and lifted scores but gate still fails 1/3 — coverage is now the blocker; Tasks 13–15 blocked pending owner decision on the 0.7 bar vs planner coverage — see Session 45)
